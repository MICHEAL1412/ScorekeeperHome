...
public class MainActivity extends AppCompatActivity {
    ...
    private final String SCORE_KEY_1 = "score1";
    private final String SCORE_KEY_2 = "score2";
    ...
    protected void onPause() {
        ...
        preferencesEditor.putInt(SCORE_KEY_1, mScore1);
        preferencesEditor.putInt(SCORE_KEY_2, mScore2);
